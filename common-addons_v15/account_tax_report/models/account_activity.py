...
class AccountMove(models.Model):
    ...
    def action_open_tax_report(self):
        action = self.env["ir.actions.actions"]._for_xml_id("account_tax_report.action_account_report_gt")
    ...
    def _close_tax_entry(self):
        ...
        tax_closing_activity_type = self.env.ref('account_tax_report.tax_closing_activity_type')
