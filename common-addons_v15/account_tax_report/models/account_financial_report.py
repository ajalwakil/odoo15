...
class ReportAccountFinancialReport(models.Model):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'account_tax_report.main_template_control_domain'
        return templates
    ...
    def _compute_debug_info_column(self, options, solver, financial_line):
        ...
        if financial_line.formulas:
            ...
            return {
                ...
                'template': 'account_tax_report.cell_template_debug_popup_financial_reports',
    ...
    def _build_headers_hierarchy(self, options_list, groupby_keys):
        ...
        if self._display_debug_info(options_list[0]):
            for i in range(len(headers)):
                if i == 0:
                    headers[i].append({
                        'template': 'account_tax_report.cell_template_show_bug_financial_reports',
                        'style': 'width: 1%; text-align: right;',
                    })
                else:
    ...
    def _create_action_and_menu(self, parent_id):
        ...
        module = self._context.get('install_module', 'account_tax_report')
...
class AccountFinancialReportLine(models.Model):
    ...
    def action_view_coa(self, options):
        ...
        return {
            ...
            'views': [[self.env.ref('account_tax_report.view_account_coa').id, 'list']],
