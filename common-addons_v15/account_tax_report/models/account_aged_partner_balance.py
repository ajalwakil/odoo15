...
class ReportAccountAgedPartner(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'account_tax_report.template_aged_partner_balance_report'
        return templates
...
class ReportAccountAgedReceivable(models.Model):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'account_tax_report.line_template_aged_receivable_report'
        return templates
...
class ReportAccountAgedPayable(models.Model):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'account_tax_report.line_template_aged_payable_report'
        return templates
