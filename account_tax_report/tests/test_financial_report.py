...
class TestFinancialReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.report = cls.env.ref('account_tax_report.account_financial_report_balancesheet0')
    ...
    def test_financial_report_single_company(self):
        line_id = self._build_generic_id_from_financial_line('account_tax_report.account_financial_report_bank_view0')
    ...
    def test_financial_report_custom_filters(self):
        line_id = self._build_generic_id_from_financial_line('account_tax_report.account_financial_report_receivable0')
        options = self._init_options(self.report, fields.Date.from_string('2019-01-01'), fields.Date.from_string('2019-12-31'))
        options = self._update_comparison_filter(options, self.report, 'custom', 1, date_to=fields.Date.from_string('2018-12-31'))
    ...
    def test_financial_report_control_domain(self):
        ...
        with self.debug_mode(self.report):
            ...
            report_line = self.env.ref('account_tax_report.account_financial_report_current_assets_view0')
            ...
            report_line = self.env.ref('account_tax_report.account_financial_unaffected_earnings0')
