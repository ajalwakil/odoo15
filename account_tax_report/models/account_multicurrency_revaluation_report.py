...
class MulticurrencyRevaluationReport(models.Model):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'account_tax_report.line_template_multicurrency_report'
        templates['main_template'] = 'account_tax_report.template_multicurrency_report'
        return templates
    ...
    def view_revaluation_wizard(self, context):
        ...
        form = self.env.ref('account_tax_report.view_account_multicurrency_revaluation_wizard', False)
        return {
