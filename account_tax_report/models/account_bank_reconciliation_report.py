...
class AccountBankReconciliationReport(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'account_tax_report.bank_reconciliation_report_main_template'
        return templates
    ...
    def _get_lines(self, options, line_id=None):
        ...
        if last_statement and not print_mode:
            reference_cell = {
                ...
                'template': 'account_tax_report.bank_reconciliation_report_cell_template_link_last_statement',
            }
        else:
            reference_cell = {'name': ''}
        ...
        if last_statement:
            ...
            if not report_currency.is_zero(difference):
                balance_cell.update({
                    'template': 'account_tax_report.bank_reconciliation_report_cell_template_unexplained_difference',
                    'style': 'color:orange;',
