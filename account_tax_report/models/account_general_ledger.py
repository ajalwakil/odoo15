...
class AccountGeneralLedgerReport(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'account_tax_report.line_template_general_ledger_report'
        templates['main_template'] = 'account_tax_report.main_template_with_filter_input_accounts'
        return templates
