...
class AccountReport(models.AbstractModel):
    ...
    def _get_templates(self):
        return {
                'main_template': 'account_tax_report.main_template',
                'main_table_header_template': 'account_tax_report.main_table_header',
                'line_template': 'account_tax_report.line_template',
                'footnotes_template': 'account_tax_report.footnotes_template',
                'search_template': 'account_tax_report.search_template',
                'line_caret_options': 'account_tax_report.line_caret_options',
        }
    ...
    def open_general_ledger(self, options, params=None):
        ...
        action_vals = self.env['ir.actions.actions']._for_xml_id('account_tax_report.action_account_report_general_ledger')
        action_vals['params'] = {
            'options': options,
            'ignore_session': 'read',
        }
    ...
    def get_html_footnotes(self, footnotes):
        template = self._get_templates().get('footnotes_template', 'account_tax_report.footnotes_template')
    ...
    def open_report_export_wizard(self, options):
        ...
        view_id = self.env.ref('account_tax_report.view_report_export_wizard').id
        return {
            'type': 'ir.actions.act_window',
            'name': _('Export'),
            'view_mode': 'form',
    ...
    def get_pdf(self, options):
        ...
        body = self.env['ir.ui.view']._render_template(
            "account_tax_report.print_template",
